...
export class HeroService {
  ...
  private heroesUrl = environment.SERVER_API;
...
/*
 ...
 searchHeroes(term: string): Observable<ResponsePaginationHero> {
  return this.http.get<ResponsePaginationHero>(`${this.heroesUrl}?name=${term}`);
